...
blog: "https://www.travisduncansecurity.com"
frameworks:
  - "NIST 800-53"
  - "NIST RMF"
languages:
...
certifications:
  ...
  - "SecurityX (CASP+)"
  - "NIST CSF Foundation"
  - "[PCAP-31-03] PCAP™ – Certified Python Associate"
available_for:
  - "speaking"
  - "work"
  - "collaboration"
projects:
  - name: "Secure S3 Deployment Template (CloudFormation)"
    url: "https://github.com/travdunc/AWS-CloudFormation-Secure-S3-Bucket"
    description: "IaC template deploying S3 buckets with public access blocked and AES-256 encryption enforced."
  - name: "eMASS Control Assessment Generator (Excel)"
    description: "Built a workbook that auto-generates standardized assessment verbiage for documenting NIST 800-53 controls in eMASS, cutting the manual writing overhead across hundreds of assessment procedures. Not elegant, but it was the fastest path off the spreadsheet treadmill with the tools available — and it's the work that convinced me most of this process is automatable."
  - name: "Weekly Vulnerability Analysis Workbook (Excel / Power Query)"
    description: "Built a Power Query pipeline to ingest and transform weekly enterprise vulnerability reports, filtering and structuring the data to support continuous monitoring and patch prioritization decisions."
---
